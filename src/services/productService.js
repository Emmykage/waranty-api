  ...
  static createProduct = async ({
    ...
    try {
      const result = await pool.query(
        'INSERT INTO products ( name, price, type, warranty, startDate, serialNumber, image_url, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *',
        [name, price, type, warranty, startDate, serialNumber, image_url, status],
      );
